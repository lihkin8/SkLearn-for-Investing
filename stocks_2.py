...
def Key_Stats(gather=["Total Debt/Equity",
    ...
    sp500_df = pd.read_csv("quandl.csv")
            ...
            for file in each_file:
                ...
                try:
                    ...
                    try:
                        ...
                        sp500_1y = datetime.fromtimestamp(one_year_later).strftime('%d-%m-%Y')
                        #print("In try 2")
                        ...
                        try:
                            sp500_1y = datetime.fromtimestamp(one_year_later-259200).strftime('%d-%m-%Y')
                            #print("In try 2")
                            row = sp500_df[sp500_df["Date"] == sp500_1y]
                            sp500_1y_value = float(row["Adj Close"])
                        except Exception as e:
